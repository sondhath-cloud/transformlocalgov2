...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $checkout_session = Session::create([
            ...
            'mode' => 'subscription',
            'success_url' => 'http://localhost:8011/subscribe.html?payment=success&session_id={CHECKOUT_SESSION_ID}',
            'cancel_url' => 'http://localhost:8011/subscribe.html?payment=cancelled',
            'metadata' => [
